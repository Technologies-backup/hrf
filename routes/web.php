...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::get('terms-seller', 'WebController@termsandConditionSeller')->name('terms-seller');
...
//Seller shop apply
Route::group(['prefix' => 'shop', 'as' => 'shop.', 'namespace' => 'Seller\Auth', 'middleware'=>['web']], function () {
    Route::get('apply', 'RegisterController@create')->name('apply');
    Route::post('apply', 'RegisterController@store');
    Route::post('otp', 'RegisterController@sendOTP')->name('otp');
    Route::post('check-otp', 'RegisterController@checkOTP')->name('check-otp');
});
