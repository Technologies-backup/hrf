...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.','middleware'=>['module:business_settings']], function () {
            ...
            Route::get('terms-condition-seller', 'BusinessSettingsController@terms_condition_seller')->name('terms-condition-seller');
            Route::post('terms-condition-seller', 'BusinessSettingsController@updateTermsConditionSeller')->name('update-terms-seller');
