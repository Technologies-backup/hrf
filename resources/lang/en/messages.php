<?php return array (
  ...
  'terms_and_condition_seller' => 'Terms & conditions for Seller',
  ...
  'terms_&_conditions_seller' => 'Terms & conditions for Seller',
  ...
  'Select your desire category' => 'Select your desired category',
  ...
  'Terms & Conditions Seller' => 'Terms & conditions for Seller',
  'Terms and Condition' => 'Terms and Conditions',
  'Terms and Condition Seller' => 'Terms & conditions for Seller',
  'About Us' => 'About Us',
  ...
  'Dear' => 'Dear',
  'register_thanks' => 'Thank you for registering with HRF Home, our team will review your profile for activation and will get back to you shortly.',
  'regitster_contact' => '',
  'new_seller' => 'New Seller',
  'new_registration' => 'A new user with the name of <strong>:name (:email)</strong> has registered as a seller on HRF Home.<span class="m-hide"><br /></span>Please check on the dashboard for review.',
  'seller_registered' => 'Registered successfully, please check your email(If not found please check your spam).',
  'Order Canceled' => 'Order Canceled',
  'Orders Reminder' => 'Orders Reminder',
  'account_approved' => 'Account Approved',
  'account_approved_msg' => 'We are happy to inform you that your account has been approved, now you can go through the seller dashboard and start setting up your store using the credetials you registered with throught this link:<br><a href="http://localhost:8000/seller/auth/login">http://localhost:8000/seller/auth/login</a><br><br>If you need any help feel free to contact us.',
  'account_rejected' => 'Account Rejected',
  'account_rejected_msg' => 'We are sorry to inform you that your account has been rejected, we will contact you shortly so we sort this issue immediately.',
  'account_suspended' => 'Account Suspended',
  'account_suspended_msg' => 'We are sorry to inform you that your account has been suspended, we will contact you shortly so we sort this issue immediately.',
  'Becom A Seller' => 'Become A Seller',
  'order paid' => 'Order paid',
  '' => NULL,
  'Google Maps Key' => 'Google Maps Key',
  'Order Update' => 'Order Update',
  'New Order' => 'New Order',
  'Account deleted succesfully' => 'Account deleted succesfully',
  'Use the code to change your password on our secure
                        website' => 'Use the code to change your password on our secure
                        website',
  'add_video_banner' => 'Add video banner',
  ...
  'seller_email_already_exists' => 'Seller with this email already exists',
  'Success' => 'Success',
  'Terms & Condition Seller' => 'Terms & Condition Seller',
);