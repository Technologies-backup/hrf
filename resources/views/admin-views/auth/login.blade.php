                        ...
                        <form class="js-validate" action="{{route('admin.auth.login')}}" method="post">
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" class="js-toggle-password form-control form-control-lg" tabindex="2"
                            ...
                            <button type="submit" tabindex="3" class="btn btn-lg btn-block btn-primary">{{\App\CPU\translate('sign_in')}}</button>
                        </form>
                        <!-- End Form -->
                    </div>
