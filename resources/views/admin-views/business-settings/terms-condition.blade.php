                                ...
                                <div class="col-md-12">
                                    @foreach(json_decode($language) as $lang)
                                        ...
                                        if (count($terms_condition->translations)) {
                                            $translate = [];
                                            foreach ($terms_condition->translations as $t) {
                                        ...
                                        <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                                                id="{{$lang}}-form">
                                            <textarea name="terms_condition[]" cols="30" rows="20" class="form-control form-ckeditor">{{$lang==$default_lang?$terms_condition->value:($translate[$lang]['value']??'')}}</textarea>
                                        </div>
