    ...
    <div class="content container-fluid">
        ...
        <div
            ...
            <form action="{{ route('admin.business-settings.update-info') }}" method="POST"
                ...
                <div class="row">
                    <div class="col-12">
                        @php($gmk=\App\Model\BusinessSetting::where('type','google_maps_key')->first())
                        <div class="form-group">
                            <label class="input-label">
                                {{\App\CPU\translate('Google Maps Key')}}
                            </label>
                            <input class="form-control" type="text" name="google_maps_key"
                               value="{{ $gmk!=null?$gmk->value:" " }}"
