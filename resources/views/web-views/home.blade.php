...
@section('content')
    ...
    {{--brands--}}
    {{-- <section class="container rtl my-3">
        <!-- Heading-->
    ...
    @if(isset($featured_deals))
        <section class="container featured_deal rtl my-3">
            <div class="row">
                    ...
                    @if(isset($deal_of_the_day))
                        ...
                        <div style="text-align: center; padding-top: 26px;">
                            ...
                            @if($deal_of_the_day->product->discount > 0)
                                <strike style="font-size: 12px!important;color:white!important;">
    ...
    <!-- Product widgets-->
    <section class="container pb-4 pb-md-5 rtl my-3">
        <div class="row">
            <!-- Bestsellers-->
...
@push('script')
    ...
    <script>
        $(function () {
            const player = new Plyr('.vid-player');

            // $('.video-js').each(function(key, value){
            //     var myPlayer = videojs($(value).attr('id'), {
            //         preload: true,
            //         autoplay: true,
            //         controls: true,
            //         loop: true,
            ...
            //     myPlayer.dimensions('750px', '422px');
