        ...
        <div class="navbar navbar-expand-md navbar-stuck-menu">
            <div class="container">
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <!-- Primary menu-->
                    <ul class="navbar-nav mt-1" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                        ...
                        <li class="nav-item  {{request()->is('/seller')?'active':''}} {{Session::get('direction') === "rtl" ? 'mr' : 'ml'}}-auto">
