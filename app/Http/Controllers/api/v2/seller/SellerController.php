...
class SellerController extends Controller
{
    ...
    public function delete_account(Request $request){
        ...
        DB::table('seller_archives')->insert([
            'id' => $seller->id,
            ...
            'sales_commission_percentage' => $seller->sales_commission_percentage,
            'gst' => $seller->gst,
            'cm_firebase_token' => $seller->cm_firebase_token
        ]);
        // SellerArchive::create($seller_arch);
        $seller->forceDelete();

        return response()->json(translate('Account deleted succesfully'), 200);
    }
