...
class BusinessSettingsController extends Controller
{
    ...
    public function about_us()
    {
        ...
        $small_about_us = BusinessSetting::where('type', 'small_about_us')->first();
        return view('admin-views.business-settings.about-us', [
            'about_us' => $about_us,
            'small_about_us' => $small_about_us,
        ]);
    ...
    public function about_usUpdate(Request $data)
    {
        ...
        $setting = BusinessSetting::where('type', 'about_us')->first();
        $setting_small = BusinessSetting::where('type', 'small_about_us')->first();
        BusinessSetting::where('type', 'about_us')->update(['value' => $data->about_us[array_search('en', $data->lang)]]);
        BusinessSetting::where('type', 'small_about_us')->update(['value' => $data->small_about_us[array_search('en', $data->lang)]]);
        foreach ($data->lang as $index => $key) {
            if ($data->about_us[$index] && $key != 'en') {
                Translation::updateOrInsert(
                    ...
                    [
                        'value' => $data->about_us[$index]
                    ]
                );
            }
            if ($data->small_about_us[$index] && $key != 'en') {
                Translation::updateOrInsert(
                    [
                        'translationable_type' => 'App\Model\BusinessSetting',
                        'translationable_id' => $setting_small->id,
                        'locale' => $key,
                        'key' => 'value'
                    ],
                    [
                        'value' => $data->small_about_us[$index]
                    ]
                );
            }
        }
    ...
    public function updateTermsCondition(Request $data)
    {
        ...
        $setting = BusinessSetting::where('type', 'terms_condition')->first();
        BusinessSetting::where('type', 'terms_condition')->update(['value' => $data->terms_condition[array_search('en', $data->lang)]]);
        foreach ($data->lang as $index => $key) {
            if ($data->terms_condition[$index] && $key != 'en') {
                Translation::updateOrInsert(
                    [
                        'translationable_type' => 'App\Model\BusinessSetting',
                        'translationable_id' => $setting->id,
                    ...
                    [
                        'value' => $data->terms_condition[$index]
                    ]
                );
            }
        }
    ...
    public function terms_condition_seller()
    {
        $terms_condition_seller = BusinessSetting::where('type', 'terms_condition_seller')->first();
        return view('admin-views.business-settings.terms-condition-seller', compact('terms_condition_seller'));
    }

    public function updateTermsConditionSeller(Request $data)
    {
        $validatedData = $data->validate([
            'terms_condition_seller' => 'required',
        ]);
        $setting = BusinessSetting::where('type', 'terms_condition_seller')->first();
        BusinessSetting::where('type', 'terms_condition_seller')->update(['value' => $data->terms_condition_seller[array_search('en', $data->lang)]]);
        foreach ($data->lang as $index => $key) {
            if ($data->terms_condition_seller[$index] && $key != 'en') {
                Translation::updateOrInsert(
                    [
                        'translationable_type' => 'App\Model\BusinessSetting',
                        'translationable_id' => $setting->id,
                    ...
                    [
                        'value' => $data->terms_condition_seller[$index]
                    ]
                );
            }
        }
    ...
    public function privacy_policy_update(Request $data)
    {
        ...
        $setting = BusinessSetting::where('type', 'privacy_policy')->first();
        BusinessSetting::where('type', 'privacy_policy')->update(['value' => $data->privacy_policy[array_search('en', $data->lang)]]);
        // $lang = [];
        foreach ($data->lang as $index => $key) {
            if ($data->privacy_policy[$index] && $key != 'en') {
                Translation::updateOrInsert(
                    [
                        'translationable_type' => 'App\Model\BusinessSetting',
                        'translationable_id' => $setting->id,
                    ...
                    [
                        'value' => $data->privacy_policy[$index]
                    ]
                );
            }
        }
        // Translation::insert($lang);
    ...
    public function updateInfo(Request $request)
    {
        ...
        DB::table('business_settings')->updateOrInsert(['type' => 'google_maps_key'], [
            'value' => $request['google_maps_key']
        ]);
        //phone verification
