...
class WebController extends Controller
{
    ...
    {
        $home_categories = Category::where('home_status', true)->orderBy('name', 'ASC')->get();
        ...
        return view('web-views.home', compact('featured_products', 'topRated', 'bestSellProduct', 'latest_products', 'categories', 'brands', 'deal_of_the_day', 'top_sellers', 'home_categories', 'small_about_us'));
    }
    ...
    public function checkout_details(Request $request)
    {
        ...
        if (count($cart_group_ids) > 0) {
            $shipping = CartManager::get_shipping_title();
            if($shipping == "Pickup"){
                session()->put('address_id', "");
    ...
    public function termsandConditionSeller()
    {
        $terms_condition_seller = BusinessSetting::where('type', 'terms_condition_seller')->first();
        return view('web-views.terms-seller', compact('terms_condition_seller'));
    }
